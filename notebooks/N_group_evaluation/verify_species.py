...
path = "/n/home12/ramith/FYP/bacteria-classification/results/Species Classification - Resnet 181645133998.8009222/latest_model_epoch-7.pth"
...
for N in [31,15,7,3,1]:
    ...
    wandb.init(project="Species - Classifier", name = f"Blind Test Evaluation() => {N}", config = cfg,  entity="ramith")
